const gearConfigs = {
  ...
  5: { name: "5", cardTitle: "5th Gear", cardBody: "From 4th, let it center, guide into 5th.", shifter: { x: 1.75, z: -1.1, down: 0 }, linkage: { x: 0.95, z: -1 }, trans: { fork: 2, collar: 0.82, active: 5 }, path: ["Let the lever spring-center", "Guide into the 5/6 gate", "Move up into 5th"], explanation: "Fifth gear is top-right in the 5/6 gate. The lever is guided into that gate rather than feeling like a hard sideways move." },
